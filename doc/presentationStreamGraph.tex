...
\frametitle{StreamIt}
	...
	\begin{block}{Base constructs}
		\begin{itemize}
			\item Filter: \textit{work}, \textit{init}-functions, as well as in- and output channels
			\item Pipeline: linear succession of StreamIt constructs
			\item Split: split data-stream on to multiple data streams
