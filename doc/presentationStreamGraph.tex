...
\frametitle{Parallelism in StreamIt}
	...
	\begin{block}{Pipeline}
		Continuous stream of data travelles through stages/filters:\\
		Filter work functions need to be constantly recalculated.\\
		Each filter can be processed independently.\\
		Therefore each filter in a pipeline may be processed parallel.
	\end{block}
\end{frame}
...
\begin{itemize}
	\item More StreamIt constructs (e.g. message passing)
	\item UI
	\begin{itemize}
